...
<head>
    ...
    <style>
        ...
        .row { font-size: 42px; margin: 8px 0; }
        ...
        <div class="body">
            ...
            <div class="right">
                <fieldset class="card">
                    ...
                    <hr class="line">
                    <div class="row">Email : <?php echo htmlspecialchars($email); ?></div>
                    <hr class="line">
                    <div class="row">Gender : <?php echo htmlspecialchars($gender); ?></div>
                    <hr class="line">
                    <div class="row">Date of Birth : <?php echo htmlspecialchars($dob); ?></div>
                    <hr class="line">
                    <div class="row"><a href="edit-profile.php">Edit Profile</a></div>
                </fieldset>
            </div>
        </div>
